                        ...
                        <div class="m-login__signin">
                            <div class="m-login__head">
                                <h3 class="m-login__title">
                                    Sign-up on Inventory-store
                                </h3>
                            </div>
                            <form method="POST" action="{{ route('register') }}">
                                @csrf
                                <div class="form-group m-form__group">
                                    <input id="name" type="text" class="form-control m-input @error('email') is-invalid @enderror" name="name" placeholder="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="form-group m-form__group">
                                    <input class="form-control m-input m-login__form-input--last @error('password-confirm') is-invalid @enderror" type="password" required placeholder="password-confirm" name="password_confirmation">
